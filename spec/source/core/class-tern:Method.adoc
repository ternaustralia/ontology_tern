...
| Shape IRI | ndd97c4101f58445d8b64d4c7ddc590dfb51
...
| Shape IRI | ndd97c4101f58445d8b64d4c7ddc590dfb56
| Status | `stable` icon:check-circle[]
...
| Shape IRI | ndd97c4101f58445d8b64d4c7ddc590dfb57
| Status | `experimental` icon:circle-o[]
...
| Shape IRI | ndd97c4101f58445d8b64d4c7ddc590dfb58
| Status | `experimental` icon:circle-o[]
...
| Shape IRI | ndd97c4101f58445d8b64d4c7ddc590dfb63
| Status | `stable` icon:check-circle[]
...
| Shape IRI | ndd97c4101f58445d8b64d4c7ddc590dfb68
| Status | `stable` icon:check-circle[]
...
| Shape IRI | ndd97c4101f58445d8b64d4c7ddc590dfb75
| Status | `stable` icon:check-circle[]
...
| Shape IRI | ndd97c4101f58445d8b64d4c7ddc590dfb76
| Status | `stable` icon:check-circle[]
...
| Shape IRI | ndd97c4101f58445d8b64d4c7ddc590dfb81
| Status | `stable` icon:check-circle[]
...
| Shape IRI | ndd97c4101f58445d8b64d4c7ddc590dfb88
| Status | `stable` icon:check-circle[]
...
| Shape IRI | ndd97c4101f58445d8b64d4c7ddc590dfb95
| Status | `stable` icon:check-circle[]
...
| Shape IRI | ndd97c4101f58445d8b64d4c7ddc590dfb96
| Status | `stable` icon:check-circle[]
| Label | method scope
...
| Shape IRI | ndd97c4101f58445d8b64d4c7ddc590dfb97
| Status | `stable` icon:check-circle[]
...
[#class-tern:Method-dcat:version]
===== Property: dcat:version
[cols="1,4"]
|===
| Property | Value

| IRI | http://www.w3.org/ns/dcat#version[`dcat:version`]
| Shape IRI | https://w3id.org/tern/shapes/tern/dcat-version
| Status | `experimental` icon:circle-o[]
| Label | version
| Definition | The version indicator (name or identifier) of the resource.
| Scope note | 
| Implementation | A `dcat:version` predicate _MUST_ have a literal value with the datatype `xsd:string`.
| Cardinality | 
| Node kind | link:http://www.w3.org/ns/shacl#Literal[`sh:Literal`]
