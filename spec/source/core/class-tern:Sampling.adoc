...
[#class-tern:Sampling-prov:startedAtTime]
...
| Shape IRI | https://w3id.org/tern/shapes/tern/Sampling-startedAtTime
| Status | `experimental` icon:circle-o[]
| Label | started at time
| Definition | The time at which the Sampling started.
| Scope note | 
| Implementation | A `prov:startedAtTime` predicate on a `tern:Sampling` _MUST_ have a literal value with the datatype `xsd:dateTime`.
| Cardinality | 
...
[#class-tern:Sampling-prov:endedAtTime]
...
[#class-tern:Sampling-tern:hasSurvey]
...
[#class-tern:Sampling-tern:sampleCollectionTime]
===== Property: tern:sampleCollectionTime
[cols="1,4"]
|===
| Property | Value

| IRI | https://w3id.org/tern/ontologies/tern/sampleCollectionTime[`tern:sampleCollectionTime`]
| Shape IRI | https://w3id.org/tern/shapes/tern/tern-sampleCollectionTime
| Status | `experimental` icon:circle-o[]
| Label | sample collection time
| Definition | The date and time at which a sample was collected during a Sampling activity.
| Scope note | 
| Implementation | A `tern:sampleCollectionTime` predicate _MUST_ have a literal value with the datatype `xsd:dateTime`.
| Cardinality | 
| Node kind | link:http://www.w3.org/ns/shacl#Literal[`sh:Literal`]
| Class type | link:http://www.w3.org/2001/XMLSchema#dateTime[`xmlschema#:dateTime`]
| Expected values | 
