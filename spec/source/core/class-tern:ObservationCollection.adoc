...
[#class-tern:ObservationCollection-tern:hasSiteVisit]
...
| Shape IRI | https://w3id.org/tern/shapes/tern/ObservationCollection-hasSiteVisit
| Status | `experimental` icon:circle-o[]
| Label | has site visit
| Definition | An ObservationCollection must reference exactly one SiteVisit.
| Scope note | 
| Implementation | A `tern:ObservationCollection` _MUST_ have exactly 1 `tern:hasSiteVisit` predicate with an IRI value of type `tern:SiteVisit`.
...
[#class-tern:ObservationCollection-dcterms:identifier]
...
[#class-tern:ObservationCollection-geo:hasGeometry]
...
[#class-tern:ObservationCollection-prov:wasAssociatedWith]
...
[#class-tern:ObservationCollection-sosa:isObservedBy]
===== Property: sosa:isObservedBy
[cols="1,4"]
|===
| Property | Value

| IRI | http://www.w3.org/ns/sosa/isObservedBy[`sosa:isObservedBy`]
| Shape IRI | https://w3id.org/tern/shapes/tern/sosa-isObservedBy
| Status | `experimental` icon:circle-o[]
| Label | is observed by
| Definition | Relation between an ObservationCollection and a Sensor or Observer that recorded it.
| Scope note | 
| Implementation | A `sosa:isObservedBy` predicate _MUST_ have a blank node or IRI value.
| Cardinality | 
| Node kind | link:http://www.w3.org/ns/shacl#BlankNodeOrIRI[`sh:BlankNodeOrIRI`]
| Class type | 
| Expected values | 
